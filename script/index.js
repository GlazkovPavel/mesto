...
const popupAddCardArray= Array.from(popupAddCard.querySelectorAll('.popup__input-text'));
const popupEditProfileArray= Array.from(popupEditProfile.querySelectorAll('popup__input-text'));
